<x-app-layout>
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold mb-4 text-indigo-800 dark:text-indigo-300 border-b-2 border-indigo-500 pb-2">
            Editar Configuración: {{ $configuracion->clave }}
        </h1>
        <div class="mb-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
            <form action="{{ route('configuracion_ordenacion.update', $configuracion->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="clave" name="clave" value="{{ old('clave', $configuracion->clave) }}" required
                    ...
                    <div class="col-span-2 md:col-span-1">
                        ...
                        <input type="text" id="valor" name="valor" value="{{ old('valor', $configuracion->valor) }}" required
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-indigo-500 dark:focus:border-indigo-500">
                    </div>
                    <!-- Descripción -->

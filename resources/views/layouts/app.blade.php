...
<body class="bg-white dark:bg-gray-900">
    ...
    <button id="sidebarToggle" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <li>
                    <a href="{{ route('dashboard') }}" 
                       class="flex items-center p-2 rounded-lg group 
                        ...
                        <span class="ms-3 sidebar-text">Información</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('dashboard') }}" 
                       class="flex items-center p-2 rounded-lg group 
                        ...
                        <span class="ms-3 sidebar-text">Libros</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('dashboard') }}" 
                       class="flex items-center p-2 rounded-lg group 
                        ...
                        <span class="ms-3 sidebar-text">Datos personales</span>
                    </a>
                </li>
            </ul>
        </div>
